...
public interface FontVersionPicMapper {
    int countByExample(FontVersionPicExample example);
    ...
    int insertBatchSelective(List<FontVersionPic> records);

    int updateBatchByPrimaryKeySelective(List<FontVersionPic> records);
}