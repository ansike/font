...
function EmailAutoComplete(options) {
    ...
    this.config = {
        ...
        mailArr        : ["@qq.com","@gmail.com","@126.com","@163.com","@hotmail.com","@live.com","@sohu.com","@sina.com"], //邮箱数组
    ...
    _renderHTML: function(cfg) {
        ...
        if(curIndex > -1){
            ...
            if(_cache.onlyFlag) {
                ...
                $('.auto-tip',cfg.parentNode).css({'position':'absolute','top':cfg.height,'min-width':cfg.width + 'px',
